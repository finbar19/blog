<div class="container px-4">
	<div class="font-sans bg-gradient-to-b from-indigo-100 to-gray-100 rounded-lg shadow-xl p-4 text-center">
		...
		<div class="w-full text-center pt-4">
			<form action="#">
				<div class="max-w-xl mx-auto p-1 pr-0 flex flex-wrap items-center">
					...
					<button type="submit" class="flex-1 mt-4 block md:inline-block appearance-none bg-indigo-500 text-white text-base font-semibold tracking-wider uppercase py-4 rounded shadow hover:bg-indigo-400">Subscribe</button>
				</div>
			</form>
		</div>
	</div>
